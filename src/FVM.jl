...
function GCell(dim::Int; rho::T = 1.0, u::Array{T} = zeros(Float64,dim), p::T = 1., gamma::Float64 = 1.4) where T <: Real
    GCell(
    # 物理量
...
mutable struct Fluid
    ...
    # 单元
    cells::DArray{GCell,N,A} where N where A
    # 虚拟网格单元
    ghost_cells::Dict{Tuple, GCell}
    # 粒子
